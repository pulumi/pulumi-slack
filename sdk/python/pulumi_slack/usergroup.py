...
class UsergroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] handle: a mention handle. Must be unique among channels, users
               and User Groups.
        :param pulumi.Input[_builtins.str] name: a name for the User Group. Must be unique among User Groups.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] users: user IDs that represent the entire list of users for the
               User Group.
        """
...
class Usergroup(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def handle(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        a mention handle. Must be unique among channels, users
        and User Groups.
        """

...
class ConversationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] action_on_destroy: indicates whether the
               ...
               name  will fail.
        :param pulumi.Input[_builtins.str] action_on_update_permanent_members: indicate
        ...
        :param pulumi.Input[_builtins.str] purpose: purpose of the channel.
        :param pulumi.Input[_builtins.str] topic: topic for the channel.
        """
...
class _ConversationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_archived: indicates a conversation is archived. Frozen in time.
        :param pulumi.Input[_builtins.bool] is_ext_shared: represents this conversation as being part of a Shared Channel
               with a remote organization.
        :param pulumi.Input[_builtins.bool] is_general: will be true if this channel is the "general" channel that includes
               all regular team members.
        :param pulumi.Input[_builtins.bool] is_org_shared: explains whether this shared channel is shared between Enterprise
               Grid workspaces within the same organization.
        :param pulumi.Input[_builtins.bool] is_private: create a private channel instead of a public one.
        :param pulumi.Input[_builtins.bool] is_shared: means the conversation is in some way shared between multiple workspaces.
        :param pulumi.Input[_builtins.str] name: name of the public or private channel.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] permanent_members: user IDs to add to the channel.
        :param pulumi.Input[_builtins.str] purpose: purpose of the channel.
        :param pulumi.Input[_builtins.str] topic: topic for the channel.
...
class Conversation(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="actionOnDestroy")
    def action_on_destroy(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        indicates whether the
        conversation should be archived or left behind on destroy. Valid values are
        `archive | none`. Note that when set to `none` the conversation will be left
    ...
    @_builtins.property
    @pulumi.getter(name="actionOnUpdatePermanentMembers")
    def action_on_update_permanent_members(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        indicate
        whether the members should be kick of the channel when removed from
        `permanent_members`. When set to `none` the user are never kicked, this prevent
    ...
    @_builtins.property
    @pulumi.getter(name="isExtShared")
    def is_ext_shared(self) -> pulumi.Output[_builtins.bool]:
        """
        represents this conversation as being part of a Shared Channel
        with a remote organization.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="isGeneral")
    def is_general(self) -> pulumi.Output[_builtins.bool]:
        """
        will be true if this channel is the "general" channel that includes
        all regular team members.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="isOrgShared")
    def is_org_shared(self) -> pulumi.Output[_builtins.bool]:
        """
        explains whether this shared channel is shared between Enterprise
        Grid workspaces within the same organization.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="permanentMembers")
    def permanent_members(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        user IDs to add to the channel.
        """
        return pulumi.get(self, "permanent_members")

...
class ConversationArgs:
    def __init__(__self__, *,
                 ...
                 action_on_destroy: Optional[pulumi.Input[builtins.str]] = None,
                 action_on_update_permanent_members: Optional[pulumi.Input[builtins.str]] = None,
                 adopt_existing_channel: Optional[pulumi.Input[builtins.bool]] = None,
                 is_archived: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 permanent_members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.bool] is_private: create a private channel instead of a public one.
        :param pulumi.Input[builtins.str] action_on_destroy: indicates whether the
               ...
               name  will fail.
        :param pulumi.Input[builtins.str] action_on_update_permanent_members: indicate
        ...
        :param pulumi.Input[builtins.bool] is_archived: indicates a conversation is archived. Frozen in time.
        :param pulumi.Input[builtins.str] name: name of the public or private channel.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] permanent_members: user IDs to add to the channel.
        :param pulumi.Input[builtins.str] purpose: purpose of the channel.
        :param pulumi.Input[builtins.str] topic: topic for the channel.
        """
    ...
    def action_on_destroy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def action_on_destroy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "action_on_destroy", value)

    @property
    @pulumi.getter(name="actionOnUpdatePermanentMembers")
    def action_on_update_permanent_members(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        indicate
        whether the members should be kick of the channel when removed from
        `permanent_members`. When set to `none` the user are never kicked, this prevent
    ...
    def action_on_update_permanent_members(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "action_on_update_permanent_members", value)

    @property
    @pulumi.getter(name="adoptExistingChannel")
    def adopt_existing_channel(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "adopt_existing_channel")

    @adopt_existing_channel.setter
    def adopt_existing_channel(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "adopt_existing_channel", value)

    @property
    @pulumi.getter(name="isArchived")
    def is_archived(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_archived.setter
    def is_archived(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def permanent_members(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def permanent_members(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ConversationState:
    def __init__(__self__, *,
                 ...
                 is_archived: Optional[pulumi.Input[builtins.bool]] = None,
                 is_ext_shared: Optional[pulumi.Input[builtins.bool]] = None,
                 is_general: Optional[pulumi.Input[builtins.bool]] = None,
                 is_org_shared: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] action_on_update_permanent_members: indicate
               ...
               `permanent_members`. When set to `none` the user are never kicked, this prevent
               a side effect on public channels where user that joined the channel are kicked.
        :param pulumi.Input[builtins.int] created: is a unix timestamp.
        :param pulumi.Input[builtins.str] creator: is the user ID of the member that created this channel.
        :param pulumi.Input[builtins.bool] is_archived: indicates a conversation is archived. Frozen in time.
        :param pulumi.Input[builtins.bool] is_ext_shared: represents this conversation as being part of a Shared Channel
               with a remote organization.
        :param pulumi.Input[builtins.bool] is_general: will be true if this channel is the "general" channel that includes
               all regular team members.
        :param pulumi.Input[builtins.bool] is_org_shared: explains whether this shared channel is shared between Enterprise
               Grid workspaces within the same organization.
        :param pulumi.Input[builtins.bool] is_private: create a private channel instead of a public one.
        :param pulumi.Input[builtins.bool] is_shared: means the conversation is in some way shared between multiple workspaces.
        :param pulumi.Input[builtins.str] name: name of the public or private channel.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] permanent_members: user IDs to add to the channel.
        :param pulumi.Input[builtins.str] purpose: purpose of the channel.
        :param pulumi.Input[builtins.str] topic: topic for the channel.
    ...
    def is_ext_shared(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_ext_shared(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_ext_shared", value)

    @property
    @pulumi.getter(name="isGeneral")
    def is_general(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_general.setter
    def is_general(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_general", value)

    @property
    @pulumi.getter(name="isOrgShared")
    def is_org_shared(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_org_shared(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Conversation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            permanent_members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            purpose: Optional[pulumi.Input[builtins.str]] = None,
            topic: Optional[pulumi.Input[builtins.str]] = None) -> 'Conversation':
        """
    ...
    @property
    @pulumi.getter(name="actionOnDestroy")
    def action_on_destroy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        indicates whether the
        conversation should be archived or left behind on destroy. Valid values are
        `archive | none`. Note that when set to `none` the conversation will be left
    ...
    @property
    @pulumi.getter(name="actionOnUpdatePermanentMembers")
    def action_on_update_permanent_members(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        indicate
        whether the members should be kick of the channel when removed from
        `permanent_members`. When set to `none` the user are never kicked, this prevent
    ...
    @property
    @pulumi.getter(name="adoptExistingChannel")
    def adopt_existing_channel(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "adopt_existing_channel")
    ...
    @property
    @pulumi.getter(name="isArchived")
    def is_archived(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        indicates a conversation is archived. Frozen in time.
        """
        return pulumi.get(self, "is_archived")
    ...
    @property
    @pulumi.getter(name="isExtShared")
    def is_ext_shared(self) -> pulumi.Output[builtins.bool]:
        """
        represents this conversation as being part of a Shared Channel
        with a remote organization.
        """
    ...
    @property
    @pulumi.getter(name="isGeneral")
    def is_general(self) -> pulumi.Output[builtins.bool]:
        """
        will be true if this channel is the "general" channel that includes
        all regular team members.
        """
    ...
    @property
    @pulumi.getter(name="isOrgShared")
    def is_org_shared(self) -> pulumi.Output[builtins.bool]:
        """
        explains whether this shared channel is shared between Enterprise
        Grid workspaces within the same organization.
        """
    ...
    @property
    @pulumi.getter(name="permanentMembers")
    def permanent_members(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        user IDs to add to the channel.
        """
        return pulumi.get(self, "permanent_members")
